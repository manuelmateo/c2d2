    ...
    public static String toString(final Annotation a) {
        ...
        for (final Method m : a.annotationType().getDeclaredMethods()) {
            ...
            try {
                ...
                throw new UncheckedException(ex); //Test
            }
        }
        return builder.build();
    }
        ...
        public static String toString(final Annotation a) { //Test
        final ToStringBuilder builder = new ToStringBuilder(a, TO_STRING_STYLE);
        for (final Method m : a.annotationType().getDeclaredMethods()) {
            if (m.getParameterTypes().length > 0) {
                continue; // what?
        ...
        public static String toString(final Annotation a) {
        final ToStringBuilder builder = new ToStringBuilder(a, TO_STRING_STYLE);
        for (final Method m : a.annotationType().getDeclaredMethods()) { //Added Comment
            if (m.getParameterTypes().length > 0) {
                continue; // what?
            }
            try {
    ...
    public static int hashCode(final Annotation a) {
        ...
        for (final Method m : type.getDeclaredMethods()) {
            try {
                ...
                res += hashMember(m.getName(), value);
            } catch (final ReflectiveOperationException ex) {
                throw new UncheckedException(ex);
            }
        }
        ...
        public static int hashCode(final Annotation a1) {
        int res = 0;
        final Class<? extends Annotation> type = a1.annotationType();
        for (final Method m : type.getDeclaredMethods()) {
            try {
                final Object value = m.invoke(a1);
                if (value == null) {
                    throw new IllegalStateException(String.format("Annotation method %s returned null", m));
                }
                res += hashMember(m.getName(), value);
        ...
        int res = 0;
        final Class<? extends Annotation> type = a.annotationType();
        for (final Method m1 : type.getDeclaredMethods()) {
            try {
                final Object value = m1.invoke(a);
                if (value == null) {
                    throw new IllegalStateException(String.format("Annotation method %s returned null", m1));
                }
                res += hashMember(m1.getName(), value);
            } catch (final ReflectiveOperationException ex) {
                throw new UncheckedException(ex);
            }
        }
        ...
        for (final Method m : type.getDeclaredMethods()) {
            try {
                final Object val = m.invoke(a);
                if (val == null) {
                    throw new IllegalStateException(String.format("Annotation method %s returned null", m));
                }
                res += hashMember(m.getName(), val);
            } catch (final ReflectiveOperationException ex) {
                throw new UncheckedException(ex);
            }
        }
        ...
        public static int hashCode(final Annotation a) {
        int res = 0;
        final Class<? extends Annotation> type1 = a.annotationType();
        for (final Method m : type1.getDeclaredMethods()) {
            try {
                final Object value = m.invoke(a);
                if (value == null) {
        ...
        public static int hashingCode(final Annotation a) {
        int res = 0;
        final Class<? extends Annotation> type = a.annotationType();
        for (final Method m : type.getDeclaredMethods()) {
            try {
